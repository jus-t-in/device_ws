...
static const _MiiviiTime_type_support_symbol_names_t _MiiviiTime_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, miivii_gmsl_camera, msg, MiiviiTime)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, miivii_gmsl_camera, msg, MiiviiTime)),
  }
};
...
{
  return &::miivii_gmsl_camera::msg::rosidl_typesupport_cpp::MiiviiTime_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, miivii_gmsl_camera, msg, MiiviiTime)() {
  return get_message_type_support_handle<miivii_gmsl_camera::msg::MiiviiTime>();
}
